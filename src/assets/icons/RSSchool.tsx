export default function RSSchool() {
  return (
    <svg
      ...
      className="fill-buttonColor-800 transition ease-in-out delay-150 hover:fill-buttonColor-400 hover:scale-105 hover:transition-all h-5 xs:h-8 sm:h-10"
    >
      ...
      <g className="st1">
        ...
        <g id="Layer_2_1_">
          ...
          <g id="Layer_1-2" className="st2" clipPath="url(#SVGID_4_)">
            <ellipse
              transform="rotate(-37.001 420.46 67.88)"
              className="st0"
              cx="420.5"
            ...
            <g className="st3" clipPath="url(#SVGID_6_)">
              <path
              ...
              <g className="st4" clipPath="url(#SVGID_8_)">
                <ellipse
                  transform="rotate(-37.001 420.46 67.88)"
                  className="st5"
                  fill="#fff"
              ...
              <g className="st8" clipPath="url(#SVGID_10_)">
                <ellipse
                  transform="rotate(-37.001 420.46 67.88)"
                  className="st5"
                  fill="#fff"
